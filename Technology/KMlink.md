...
## Alternatives
- See also [[Mac Automation]], a [[Stream Deck]] plugin that provides multiple options for triggering [[Keyboard Maestro]] macros as well as a wide variety of other automations (e.g. apps, files, scripts, URLs, [[Shortcuts]] shortcuts).
