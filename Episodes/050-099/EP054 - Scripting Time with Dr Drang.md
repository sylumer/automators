...
| 04:53      | took a woodworking class from this famous woodworker named Sam Maloof. Sam's gone now, but he made     |
...
| 08:08      | maybe just running a second script. At least that's what I do. So I have a couple of Keyboard          |
| 08:12      | Maestro macros, which run one AppleScript, and then they run another AppleScript, and                |
...
| 08:30      | separate AppleScripts and run it through Keyboard Maestro. Keyboard Maestro saves the day again.      |
| 08:34      | You are very wise. But getting back to Dr. Drang's teeth, I really                                     |
| 08:38      | like the fact that you do use these kind of consumer level automation tools like Keyboard              |
| 08:46      | Maestro and the usual suspects, but then you go into scripting and programming as well.                |
...
| 09:51      | else. And you, you see people, and you can see people who have been writing Keyboard                   |
| 09:57      | Maestro macros or shortcuts that have many steps, and that include pretty sophisticated                |
...
| 11:37      | And I am at docs.python.org all the time. Even after 15 years, I still go there because                |
...
| 12:02      | all the time. You're all, I'm always looking at the documentation or looking at Stack Overflow         |
...
| 13:07      | you know, that you're always in the docks. So, so I feel like I, I think that's what                   |
...
| 18:15      | or Python or AppleScript or parole or Ruby or whatever.                                               |
...
| 20:10      | similarly, if you're a draft user, well, you really should learn JavaScript because although           |
...
| 20:45      | And Greg put in, Greg put JavaScript in there because he knew that he was not going to be              |
...
| 21:58      | draft doesn't have a template for that. So I could have found it out to shortcuts and                  |
| 22:03      | got shortcuts to, to figure out what next Monday is. But that's actually kind of complex               |
| 22:06      | in shortcuts. But instead, agile tortoise added a great date math plugin for JavaScript.               |
...
| 23:02      | the information back in. That's, that's another thing that Greg has done that's very, that's           |
...
| 25:27      | write an AppleScript and I, I'm a big user of AppleScripts, but I understand that the                |
...
| 25:47      | years ago, I went to [Code Academy](https://codecademy.com) and it's code Academy.com. They've got a free JavaScript             |
...
| 31:14      | into something nice and clever? No, it does. None of those things matter. It, it gets                  |
...
| 33:45      | your creativity. Go to Deevon Technologies.com/automators to get 10% off. DEVONthink             |
| 33:52      | is such a great sponsor for the automators because it's so automation friendly. Devin                  |
| 33:57      | think is the flagship product from Deevon Technologies and it's a professional document                 |
...
| 35:32      | right now. Just go to Deevon Technologies.com/automators. That's devintechnologies.com           |
| 35:39      |/automators, A-U-T-O-M-A-T-O-R-S for that 10% off. And our thanks to Deevon Technologies           |
...
| 41:35      | got to mix the clipboard. I've got to mix contacts and Texttastic. That means shortcuts.              |
...
| 44:12      | AppleScript's not the most compact language in the world.                                             |
...
| 47:40      | the tools were almost there. Like if Al, I'm sorry, if Sal had just been able to get the               |
| 47:47      | team to get, you know, auto the automator to like plug into contacts better. And I know                |
...
| 48:26      | fly through it. Contacts is not one of them, unfortunately.                                            |
| 48:30      | You can do it though. You can do it. Absolutely, you can. It just takes a little more time.            |
| 48:34      | And you know, the, the key to me, of course, the key indication when I am writing an Apple             |
| 48:41      | Script and I know that it's, this is not something that really, and it kind of often forced into       |
...
| 49:58      | delimiters in one of my [[AppleScript]]s, I think, should I just rewrite this in a different              |
...
| 51:16      | works.                                                                                                 |
| 51:17      | Did you read, have you ever read the Steve Jobs interview? I think it was in Playboy                   |
...
| 53:56      | I learned how to program on a key punch machine. Well, you do not want to work on a key punch          |
...
| 55:04      | This episode of Automators is brought to you by Techs Expander from our friends at Smile.              |
| 55:08      | Techs Expander boost your business productivity by allowing your team to communicate smarter,          |
...
| 55:22      | them. Just store them in Techs Expander instead. I discovered Techs Expander about 10 years            |
...
| 55:48      | I recommend Techs Expander to anybody who types a lot and reuses elements of their text, especially    |
...
| 56:08      | any place you frequently type the same things. And Techs Expander for Teams makes it easy              |
| 56:13      | to manage and share snippets across your entire company.                                               |
| 56:17      | Techs Expander is available for Mac, Windows, Chrome, iPhone and iPad, and automated listeners         |
| 56:23      | get an extra 20% off in their first year. Visit TextExpander.com to learn more about                  |
| 56:29      | Techs Expander. Our thanks to Techs Expander for their support with this show and really AFM.          |
...
| 58:43      | correspondence with clients, don't do that anymore, it's all email. And in addition to that,           |
...
| 59:06      | the client's name, the client's email address, what are the things? Oh, also this database             |
...
| 01:02:07   | runs AppleScript through the OSA script command that comes with the Mac. So long ago, many years      |
...
| 01:02:37   | And one of them is called AS run, AppleScript run. So it takes a string and runs it as if it          |
...
| 01:03:01   | SQL light to create this database. It also uses air table because at one time I thought I was          |
| 01:03:07   | going to move from SQL light to air table, but I wasn't quite sure. So now it ends up                  |
...
| 01:03:28   | It then creates a folder in mail for this project. And that's also done through an Apple               |
| 01:03:35   | script that's run via Python. And the final thing it does is it asks me where I,                       |
...
| 01:05:48   | written about it on Six Colors, where he has essentially templates for creating new projects,          |
...
| 01:11:16   | And you can download a program, a specialised program. They're called Apps. It's called ScanPro+    |
...
| 01:12:52   | experimenting with recently is putting all of the formats for the structure in Data Jack,              |
...
| 01:13:20   | what's the episode number? And then it opens audio hijack and Google Docs and air table and            |
...
| 01:13:50   | folder for me. But that's all done with Keyboard Maestro. I think Jason, you can, people go look       |
| 01:13:56   | at Six Colors, Jason, and search on template. But I think Jason uses, I think he uses Apple            |
| 01:14:04   | Script for some of this, and I think what he does is copy a template of folders and subfolders         |
...
| 01:15:59   | In honesty. But then I wrote it into an AppleScript and a keyboard                                    |
| 01:16:06   | master script, because then it becomes part of the overall, hey, new client thing, create a set        |
...
| 01:18:13   | that's partly because [[AppleScript]] has some cool ways of searching for people in your context          |
...
| 01:20:35   | none of it is mentally engageing. Writing the automation is mentally engageing,                          |
...
| 01:22:34   | an extra three months free on a one-year package. That's E-X-P-R-E-S-S-V-P-N.com/Automators      |
...
| 01:23:23   | My thoughts are that that XKCD cartoon that talks about this famously, whenever anybody                |
| 01:23:32   | wants to complain to you that you're spending too much time on making your automation,                 |
| 01:23:38   | as compared to the time you save, they will link to this XKCD cartoon that is a graph. And             |
...
| 01:31:14   | And now I don't even run a shortcut. I have Zapier trigger push cut automation server,                 |
...
| 01:33:44   | become a hostile environment. And you're spending more time in the MPU forums and the automators       |
...
| 01:34:31   | But leancrew.com, L-E-A-N-C-R-E-W.com. And that's where virtually everything I do is nowadays.         |
| 01:34:41   | And I kind of, you can look through there to see how much work I have at my real job by                |
| 01:34:49   | how often I'm posting. Yeah. And then when you get to leancrew.com,                                    |
| 01:34:54   | then the name of the blog is the John Linen quote, right?                                              |
| 01:34:57   | And now it's all this. Yeah, it's a good thing I don't try to make money off the internet because      |
| 01:35:04   | I'm miserable at it. Yeah. Well, either way, you are a treasurer and all of us automators like         |
...
| 01:35:20   | And you will not find Dr. Drang on Twitter, but you will find him at the Automators forums at          |
| 01:35:26   | talk.automators.fm with a loving group of nerds. I love that forum because everybody there is just     |
