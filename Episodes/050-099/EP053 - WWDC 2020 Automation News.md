...
| 04:14      | I kind of feel it would have been better to do the opposite as well. I for people would             |
...
| 04:27      | sure has hunt, you know, definitely more than me, you know, we're going to be spending              |
...
| 07:12      | called home screen, and then I added home screen too, because I wanted to try stacking.             |
...
| 07:27      | most of their, their widgets because it's Swift UI only, which is Apple's new user interface        |
| 07:35      | design, which they released last year and they've added to this year. And it's non-interactive      |
| 07:41      | except shortcuts. So if I tap on a shortcut's shortcut inside of a widget, then it actually         |
...
| 11:49      | launch cuts in my dock and I have shortcuts on my home screen because even though we got            |
| 11:53      | folders inside of shortcuts, I think launch cuts has not been sure looked here because              |
| 11:57      | launch cuts does smart folders. And so for me, the smart folders alone, like I'm going              |
...
| 12:17      | Yeah. Just like so often, it's like the difference between calendar and Fantastic                   |
| 12:21      | Cal. I mean, Apple will do a good job of it.                                                        |
| 12:24      | Oh yeah.                                                                                            |
...
| 13:23      | else with like calendar and in a battery life and stuff where I can swipe between those.            |
...
| 17:31      | and automatic time tracking stuff. And if you have app based timing, like you open Omni             |
| 17:37      | Focus and it starts your planning timer. Now you could have it stop the timer when you              |
...
| 20:11      | I'm sorry. I would wait until beta two. Don't forget my rebooted because I washed my hands          |
...
| 20:28      | Yeah, Stephen will do it. That's always a good reason. Do you have a Mac museum?                    |
...
| 21:54      | been covered this in the shortcuts field guide. But the gating problem was always you have          |
| 21:59      | to be aware to run the shortcut. And now you don't, there's a trigger that does it for              |
| 22:05      | you. So it just it looks that if a shortcuts can monitor battery level and do that in kind          |
...
| 24:04      | iOS apps that scale, aka.ms slash iOS and Azure. Microsoft takes iOS development seriously.         |
...
| 24:21      | and all of RelayFM. Just head to aka.ms slash iOS and Azure to learn more. Thanks, Microsoft.       |
...
| 25:49      | Even time of day. So I have one that runs at 10 p.m. at night that just checks some stuff           |
| 25:54      | and sends me a notification about my only focus statistics. It just works.                          |
| 25:58      | Yeah, I did. I set it up immediately too. I have a large Dev and Think database and                 |
| 26:05      | getting that synced on the iPad takes some time. So every night now at 2 a.m., my iPad              |
| 26:11      | turns itself on, opens Dev and Think and just leaves itself going. And then when I wake             |
| 26:17      | up in the morning, it's always got the most current synchronisation data from Dev and               |
| 26:22      | Think. Which is great, especially when you're still getting something like that set up.             |
...
| 27:23      | Yeah, ask when running is turned on by default. And my only nickel with shortcuts automations       |
...
| 28:06      | because I do actually use notifications. And I don't want to divert everything to push              |
| 28:11      | cut, um, which I could do, but I would, I would like to keep shortcuts notifications                |
...
| 29:01      | have it start a workout and put yourself in a stir without having to fiddle with your               |
...
| 31:18      | variables around in another section of your F. You can just duplicate. You can also copy            |
...
| 32:04      | Agreed. Yeah. So all of my air table shortcuts are about to drastically improve. Amen. Amen.        |
...
| 32:58      | example, carrot weather, because carrot is definitely going to do this. I can tell they're          |
...
| 33:20      | Yeah. Like for instance, let's say that you have the home kit, uh, complication because             |
| 33:27      | you like to turn your lights off and on from your watch, but really you're only running             |
| 33:31      | two different scenes. You know, you open home kit and you, there's only two scenes you're           |
...
| 33:47      | having to go through the home kit app and you could even add some, you know, play some              |
| 33:51      | music to it or whatever. And, um, that's awesome. I say, I'm using the word awesome                 |
| 33:57      | too much today, but I'm very excited about all these shortcut tools.                                |
...
| 34:45      | the, um, but all this stuff, I'm going to make videos for a severe shortcuts customer               |
| 34:50      | that, that will, will be when it releases, I'll have a bunch of videos on this. It's                |
| 34:54      | going to be fun.                                                                                    |
| 34:55      | And I'm going to be updating take control of shortcuts as well for anybody who's, who's             |
...
| 36:56      | we're clear.                                                                                        |
| 36:57      | Okay. So here's the thing. I read on Reddit. Um, well, my watch was busy installing the             |
| 37:03      | watchOS beta that apparently these actions also work if you're not on the watchOS beta.             |
| 37:09      | So if you're just going to do it for these things, David, please do me a favor and try              |
...
| 37:52      | So I have a swimming workout or a, yeah, it's a swimming workout, um, trick out.                    |
...
| 41:35      | I've just, you know, he just, Greg just keeps making the app so much better.                        |
...
| 42:00      | create [[Drafts]] and it gets those UIDs and saves them back to air table so that from air table,       |
...
| 43:19      | Um, yes, there used to be a feature when it was workflow where you could import a workflow          |
| 43:26      | files.                                                                                              |
| 43:27      | Yeah.                                                                                               |
...
| 43:37      | Um, you could still import dot shortcut files and then last year it went away and people            |
...
| 48:09      | Just go to Devin Technologies.com/Automators.                                                 |
| 48:14      | That's Devin Technologies.com/Automators for 10% off.                                         |
| 48:18      | Our thanks to Devin Technologies for their support of the show and all of Relay FM.                |
...
| 49:40      | and I got an Echo Dot recently, David.                                                              |
...
| 51:15      | Which was better, but then some devices like, I think it was the Sonos Play 1, didn't have          |
| 51:20      | enough space on the chips to update to stuff with AirPlay 2, which is part of HomeKit.              |
...
| 51:46      | at your door.                                                                                       |
| 51:47      | Like if it recognises roses at my door, my HomePod will say roses at your door.                     |
...
| 53:48      | people who've previously used Flux and for those of us who use ColourShift on our iOS                |
...
| 56:38      | I, I installed the beta big sir on my laptop, I think Rose, you've done the same as well.           |
...
| 57:03      | It could be JF preset who's been on the show before it could be Scotty or it could be Jim,          |
...
| 58:05      | exists in my experiments on big sir, but [[Hazel]] still works.                                         |
| 58:10      | Um, Keyboard Maestro works fine.                                                                    |
| 58:12      | There's no problems and AppleScripts obviously still work.                                         |
...
| 59:18      | benefit.                                                                                            |
| 59:19      | Imagine something like push cut as push cut server on your Mac running your shortcuts.              |
| 59:23      | Yes.                                                                                                |
...
| 01:01:24   | But I also know that some applications like the the CAD applications do not work in virtual         |
| 01:01:30   | machines basically.                                                                                 |
...
| 01:01:58   | And I'd point you toward to this week's episode of MPU because Steven actually did a bunch          |
...
| 01:03:41   | What this means is that when you write an application that has AR in it, you no longer              |
...
| 01:06:05   | And all the developers will be there going, you know, James Thompson, creator of PCalc,           |
...
| 01:08:47   | You can get in the forums at talk.automators.fm, also the show's website is at automators.fm.       |
| 01:08:53   | We think our sponsors this week, and that's our friends over at Microsoft and Devon think.          |
