...
| 02:07      | Well, can I go first, John, and then go for it.                                                       |
| 02:11      | Okay.                                                                                                 |
...
| 05:02      | of people making shortcuts that you've never thought of.                                              |
...
| 07:15      | it's had a rough beginning on the Mac, but it's getting to a good place right now.                    |
...
| 11:54      | home screen.                                                                                          |
| 11:56      | But it also happens to be related to, you know, Club Mac stories.                                     |
...
| 14:42      | can send you a push notification, you tap on it and open it, and that could run the                   |
...
| 16:58      | So I agree with you, I really hope that gets worked on.                                               |
| 17:02      | Yeah.                                                                                                 |
...
| 19:06      | and you should hand it off to somebody or something else.                                             |
...
| 42:38      | you just get them under your fingers and they show up. But if you have a lot of text expansion        |
...
| 52:58      | we're trying to convince people to do this stuff and use the system. And sometimes the                |
...
| 56:52      | you never have enough debugging actions, right? You never have enough controls for designing          |
...
| 01:03:24   | cool. I actually know exactly what this action is, but you're giving me no help whatsoever            |
| 01:03:28   | here.                                                                                                 |
...
| 01:20:07   | secrets across different teams and clouds. Well, those days are over because with Doppler,            |
...
| 01:24:52   | And historically, I was running a data view filter that would look for something that                 |
| 01:24:56   | had the tag, you know, MacSparky, you know, webinar and active. And then I've got a heading          |
| 01:25:03   | there that says active webinars, and it'll look for those three tags and give me any                  |
| 01:25:07   | note that has that in it. And then when I finish it, I could just change the tag to                   |
| 01:25:12   | shipped and then it would disappear from the list. I did an experiment over the weekend               |
| 01:25:16   | where I moved a couple of those into a folder based system. And that's particularly useful            |
| 01:25:21   | for blog posts, because I've got at any one time, you know, five to 10 blog posts, I'm                |
| 01:25:27   | actively writing in five to 10 that I'm kind of cooking on. And I'm always moving them.               |
| 01:25:33   | And, and I find it kind of useful to put them in folders called active and cooking. And               |
| 01:25:39   | so rather than use a tag based system where I've got to go in and manually change the                 |
| 01:25:43   | tags, I just have a folder. Yeah. And then with data view, you can have it                            |
| 01:25:49   | say, show all items in this specific folder and then organise them by the last time you               |
| 01:25:56   | worked on them. And, and I, you can put in a list or you can put a table, I'm putting                 |
| 01:26:00   | that one in a table. And so then it just discloses what's in my active folder, what's in my cooking   |
| 01:26:07   | folder, and it puts on that right on the Sparky OS page. And then I can just click into any           |
| 01:26:11   | one that I want to see. And that experiment has been working pretty well. I think I may               |
| 01:26:16   | expand the folder based kind of system over the tag based system and some of the other                |
| 01:26:20   | kind of project areas of my life.                                                                     |
| 01:26:22   | Yeah, yeah, no, I've primarily ended up sticking to folders for things like that as well. For         |
| 01:26:27   | example, my blog posts are in a folder. And yes, there are lots of ideas, which very slowly           |
...
| 01:27:53   | your fingers, but you have to like to put your hand on the keyboard to do it. And so                  |
| 01:27:57   | I can move a note to a different folder very quickly. And the reason why the folder thing             |
...
| 01:28:49   | say from folder or from anything with this tag and so on. But I it's one of those things,             |
| 01:28:55   | I love the idea. But what I struggle with at the moment, and I was actually kind of hoping            |
| 01:29:00   | you might have a solution for this, David, is the time or the date is not necessarily                 |
| 01:29:06   | actually from when I created the file or when I modified the file. Instead, it might actually         |
| 01:29:11   | be a date in the metadata in the file, like in the AML header, which I use. And I've not              |
| 01:29:17   | yet found a way to do that. And I was hoping that you might have found a way because, you             |
| 01:29:21   | know, you've often found sneaky little ways to solve problems like that.                              |
| 01:29:24   | Yeah, I haven't needed that. So I have never played with it. What's the context that you're           |
| 01:29:29   | using it in?                                                                                          |
| 01:29:30   | Well, for me, I was actually trying to use it to plan out some stuff at work where I'd                |
| 01:29:35   | written down, you know, a bunch of the the upcoming deadlines for various different things.           |
| 01:29:40   | And there were there were notes for each thing that had a deadline or for each deadline. And          |
| 01:29:45   | I just wanted to pull all of those in. So what I've ended up doing is I'm not now remembering         |
| 01:29:52   | how I did this correctly. And of course, this is on my my work machine, so I can't pull               |
| 01:29:56   | up the files here to check. But I put the the deadline date into the file name, which                 |
| 01:30:00   | I was then able to parse out, because you can get the date from the file name, but I                  |
| 01:30:05   | wasn't able to get it out to the metadata. Maybe one of our listeners has a solution                  |
| 01:30:08   | to this problem for me. If you do, please feel free to post in the thread for this episode            |
| 01:30:13   | or or email me. But yeah, I quite like it. I was also looking at doing a sort of content              |
| 01:30:20   | calendar with it for a few different things that I've got coming up where it's like I                 |
| 01:30:25   | just want nice big overviews of things. But each each event is basically something where              |
| 01:30:30   | I need a note. And I thought that it might be something that you were doing with your                 |
| 01:30:34   | MacSparky Labs, because I know that there's a lot of planning and everything involved                |
| 01:30:37   | in that too.                                                                                          |
| 01:30:38   | Yeah, so what I do my content calendar is in my calendar. And I'm going to cover this                 |
| 01:30:44   | in that webinar. But the I have made planning calendars for every like major area of MacSparky,              |
| 01:30:51   | like there's a planning calendar for podcasts, there's a plan order for labs and              |
| 01:30:56   | for the field guides. And so I make day long events for plan days on particular items of              |
| 01:31:04   | publication or content. And then using Fantastical, they have this amazing new quarter view,        |
...
| 01:35:01   | there. But and I did some experimentation. I'm in the midst of I'm going to be doing some stuff       |
| 01:35:06   | in the max parking labs further with it. But there is a really great like tasks plugin for [[Obsidian]].  |
...
| 01:35:52   | ends up making you go, I don't want to open that app, because everything is in there. Like,           |
| 01:35:58   | your entire calendar is in there, all of your tasks are in there. And all you wanted to do            |
| 01:36:02   | was jot down a quick note. And I find that, you know, if I will end up avoiding apps, if it feels     |
| 01:36:08   | like they've got like trolls in the shadows waiting to grab me. And so I like by splitting            |
| 01:36:15   | things up a bit, then I can see OmniFocus, you know, there's 10 things there. But honestly,           |
| 01:36:19   | those are things that I actually did before the show today, before recording that I just              |
...
| 01:37:11   | I don't feel a particular pressure to go and write a blog post at this precise moment in time.        |
| 01:37:17   | Yeah, you and I are kind of on the same page with that. Although I am really trying to                |
| 01:37:22   | delegate some more of the back end stuff. Like, you know, I've been on a roller coaster between       |
| 01:37:29   | shutting down the law practice and getting the labs up and the stuff I'm doing, but I'm starting to   |
| 01:37:34   | kind of get things referring to smooth out a bit. And I just haven't had time up until now to figure  |
| 01:37:39   | out what I can delegate. But if I end up delegating some of that stuff, then it will turn into tasks. |
| 01:37:46   | But for now, like getting a blog post up for me, I don't need a checklist for that. That's just a     |
| 01:37:50   | waste of time. Yeah, yeah, exactly. And like for me, just having the blog post there, like any        |
| 01:37:57   | notes of anything in particular that I want to write, I just put it in the actual post file.          |
| 01:38:03   | I'm really trying to simplify things like that. If it's just an idea for a blog post,                 |
| 01:38:07   | it gets a file. It doesn't matter, you know, whether or not there's loads of detail in there,         |
...
| 01:38:52   | things. And I'm really pleased that I was able to accomplish that because I just                      |
| 01:38:57   | just added a note. And then I added a little bit to the note and things just kind of snowballed       |
| 01:39:01   | until I realised, hey, my entire home network pretty much is documented, which clearly means          |
| 01:39:05   | it's time for it to redesign my home network and adjust how everything is laid out. But yeah,         |
...
| 01:40:22   | I've got multiple channels. It's not just a blog, but I've got podcasts, blogs, labs, field guides,   |
| 01:40:28   | and I found myself getting hung up when I get a new idea, but like, well, where does it really        |
| 01:40:33   | fit? So now I just capture what I call content ideas. And it's just a content idea. And I,            |
| 01:40:39   | I've got a category there and I flag it at the time I capture it with active or future.               |
| 01:40:44   | And so I can look at ideas. And then when I have time to think about, say, oh,                        |
| 01:40:48   | this would be a great blog post, or this should be something I should run for the                     |
| 01:40:51   | MacSparky Labs, or this should be an episode with me and Rose. And, and, and actually taking         |
...
| 01:42:43   | and we've got some fun things planned for next episode too.                                           |
| 01:42:45   | Yeah, we should probably have said that at the beginning of the show, but you know,                   |
| 01:42:47   | there you go. We're excited. We talked about automation. Thank you to our sponsors,                   |
| 01:42:53   | Electric Smile, Hunter Douglas, and Doppler. We'll see you next time.                                 |
| 01:42:56   | Goodbye, everyone.                                                                                    |
