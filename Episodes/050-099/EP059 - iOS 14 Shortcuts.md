...
| 01:23      | new stuff for shortcuts with iOS 14.                                                                     |
...
| 03:16      | Yeah.                                                                                                    |
| 03:17      | Yeah.                                                                                                    |
| 03:18      | You've always had the ability to turn shortcuts into sharing button shortcuts where you hit              |
...
| 04:56      | It's like a music quiz game for your watch.                                                              |
...
| 06:57      | like they'll they'll they'll rotate and then you'll lose your place because it just moves                |
...
| 08:56      | you go in the other room and then three hours have passed and you've lost your standing                  |
...
| 12:28      | system so that I could specify that this shortcut belongs in this folder on my iPhone, but in            |
...
| 16:21      | at it running.                                                                                           |
| 16:23      | And now with iOS 14 with the widgets, if you tap on it in a widget, then it kind of runs                 |
...
| 20:43      | time for automators, so it's going to be checking the calendar.                                          |
...
| 22:53      | Go ahead and listen to it now.                                                                           |
...
| 24:37      | put the new one and you can copy and paste actions between them.                                         |
...
| 31:39      | But let's talk about the new triggers and the existing triggers and what you can do                      |
...
| 34:05      | Unfortunately, there is still no way to find out which app was opened, and if it was opened              |
| 34:11      | or closed.                                                                                               |
...
| 36:12      | So I didn't want to have to figure out everything and replicate it multiple times, even with             |
...
| 38:16      | And then it says, you know, oh yeah.                                                                     |
...
| 40:16      | To get your new unlimited wireless plan for just 30 bucks a month and get the plan shipped               |
...
| 42:30      | all right.                                                                                               |
| 42:31      | And it turns out everything was all right.                                                               |
...
| 44:25      | So I always want to know what I'm doing and what I'm heading into and I get all that data                |
...
| 46:09      | The experiments have worked so far, but I've got three different podcast partners and different          |
...
| 49:57      | I really wish you could rename these because you can't right now.                                        |
| 50:01      | Yeah.                                                                                                    |
...
| 51:56      | But instead I have, you know, 7am, 8am.                                                                  |
| 51:59      | Yeah.                                                                                                    |
...
| 58:26      | So if you think that you're going to want it in a couple of months, it might be worth                    |
...
| 01:03:05   | That would be great because I have 954 shortcuts.                                                        |
...
| 01:05:31   | Okay.                                                                                                    |
| 01:05:32   | To start with, there was a feature I discovered very recently where if you tap and hold on               |
...
| 01:07:14   | Okay.                                                                                                    |
| 01:07:15   | So, I've only got four in there, but I've got two sets of four, so I'm kind of cheating,                 |
| 01:07:19   | but not much.                                                                                            |
| 01:07:20   | Good.                                                                                                    |
| 01:07:21   | Well, you're loaded.                                                                                     |
| 01:07:22   | Are you okay if we share some of the pictures with the...                                                |
| 01:07:26   | Yeah, yeah, I will take a screenshot.                                                                    |
| 01:07:29   | The problem is taking a screenshot of everything that's actually in the stack.                           |
| 01:07:35   | Wait, if I edit the stack, I could take a screenshot of that and show people what's in the stack.        |
| 01:07:42   | Yeah.                                                                                                    |
| 01:07:43   | So, I've done, and I'll share mine as well here, but it's also over on Mac Power Users,                  |
| 01:07:47   | but on the home screen, I have the large Fantastical view that has both the calendar month and           |
| 01:07:56   | then the upcoming appointments on it, and then below that, the medium-sized widget for                   |
| 01:08:02   | shortcuts with those big four that I talked about during the show.                                       |
| 01:08:05   | So, I don't have any apps on my home screen except in the dock at this point.                            |
| 01:08:09   | Wow.                                                                                                     |
| 01:08:10   | Yeah.                                                                                                    |
| 01:08:11   | So, I would try that, but I'm not 100% sure about it yet.                                                |
| 01:08:14   | Yeah, and then I just flip over to App Switcher on the next screen, so I've really kind of               |
| 01:08:18   | gone all in with this, and I'll be curious to see where I'm at six months, but I'm pretty                |
| 01:08:22   | happy with it as it is.                                                                                  |
| 01:08:24   | Yeah, I've been experimenting a little bit with some other apps, Widgetsmith, definitely                 |
| 01:08:30   | one of them.                                                                                             |
| 01:08:31   | That's on my second screen right now, but there's also Color Widgets and WidgetPack, and WidgetPack        |
| 01:08:39   | is particularly interesting to automators listeners because it's updated by shortcuts.                   |
| 01:08:44   | So, for example, I have NASA photo of the day, and it does that through shortcuts, where                 |
| 01:08:54   | it gets the astronomy photo of the day for you, and like countdowns to things, and it                    |
| 01:08:59   | can do a shortcuts grid of nine shortcuts in that space, which I'm still considering.                    |
| 01:09:05   | I kind of like the idea, but I'm not 100% sold on it yet, where you can do all of that,                  |
| 01:09:13   | and I'm finding it really interesting.                                                                   |
| 01:09:14   | I want to see what new apps we get this year with iOS 14 from developers making stuff for                |
| 01:09:19   | shortcuts.                                                                                               |
| 01:09:20   | Yeah, it's like an explosion of widget apps right now, and between now and the time we                   |
| 01:09:25   | record the next show, there'll probably be 10 more, at least, and it'll be 10 more contenders,           |
| 01:09:32   | but it'll be fun to see how all this plays out, and it's also cool to see that non-power                 |
| 01:09:41   | users are getting into these widgets and using them to decorate their home screens and do                |
| 01:09:46   | all this cool stuff.                                                                                     |
| 01:09:47   | So, I'm looking forward to see how this all plays out.                                                   |
| 01:09:49   | Me too.                                                                                                  |
| 01:09:50   | All right, that does it for this episode.                                                                |
| 01:09:53   | If you are using the new shortcuts in fun and interesting ways, you should probably go                   |
| 01:09:57   | over to the Automators forums or was it talk.automators.fm.                                              |
| 01:10:04   | You can find our show over at relay.fm.automators, and you can find the show's website at automators.fm. |
| 01:10:11   | We want to thank our sponsors for today, the Intrazone by Microsoft SharePoint, Mint Mobile,             |
| 01:10:16   | and Sidequest, and we'll see you in a couple of weeks.                                                   |
| 01:10:20   | Goodbye, everyone.                                                                                       |
