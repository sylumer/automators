...
| 00:28      | Yeah.                                                                                                 |
| 00:29      | Yeah, I mean, sometimes you just have to grab it, like we're going to talk about Stream               |
| 00:33      | Decks later and I've been picking one up and taking it with me.                                          |
| 00:36      | So, you know.                                                                                         |
...
| 00:50      | One of our favourite automation apps for the Mac, Keyboard Master came out with a whole                |
...
| 01:06      | on our stream dex because Rose and I are both Stream Deck enthusiasts and we both have been           |
| 01:11      | using them and we thought it'd be fun to just check in to see what software we're using               |
| 01:14      | and some cool tricks we're doing with the stream dex, but the big show today is all                   |
| 01:19      | about Keyboard Master 11.                                                                             |
| 01:21      | Peter has released a new update and man, he always delivers the goods, doesn't he?                    |
| 01:28      | Oh, yeah.                                                                                             |
| 01:29      | Yeah.                                                                                                 |
| 01:30      | And Keyboard Master is one of those apps that it will have plenty of bug fixes and improvements       |
...
| 02:14      | And Keyboard Master really is an application on a model from days gone past.                          |
...
| 03:47      | I don't want to get that done first, but there'll be a free update to the Keyboard                    |
| 03:50      | Maestro Field Guide, and I will be covering the version 11 upgrade.                                   |
...
| 06:35      | for folks.                                                                                            |
| 06:36      | How do you organise your macro groups or you could also call them folders, but in Keyboard            |
| 06:40      | Maestro you have groups of macros.                                                                    |
...
| 07:03      | So I have podcast colon automators.                                                                   |
| 07:06      | I have podcast colon iOS today.                                                                       |
| 07:08      | And then I have some further ones, which is like podcast colon iOS today pipe air table.              |
| 07:14      | And this is like for ones very specific to air table for the iOS today podcast.                       |
| 07:21      | And I've also been creating one that says podcast colon automators pipe notion spoiler alert          |
| 07:26      | folks.                                                                                                |
...
| 07:40      | And just podcast general is them right at the bottom, which really doesn't help.                      |
| 07:45      | And then other than that, if it is an application specific one, it will say app colon Firefox         |
| 07:53      | app colon finder.                                                                                     |
| 07:55      | If it's machine specific group, it'll be Mac colon, because Mac stands conveniently for               |
...
| 08:12      | So yeah, I tend to either have things in just the general group, like the all micros group            |
...
| 08:52      | You know, like a lot of them will just be, you know, like work colon Citrix, work colon               |
| 08:57      | Firefox, work colon Microsoft Teams, and so on.                                                       |
...
| 09:10      | Like you, I do a lot of public display of my keyboard, my shirt, cause I teach courses                |
...
| 09:28      | I have like a bunch that are called app APP colon and then the name of the app.                       |
| 09:33      | And some of those, I'm a big fan of the feature in keyboard my show where you can say, just           |
| 09:39      | trigger this macro in this app.                                                                       |
| 09:43      | Yeah.                                                                                                 |
| 09:44      | I mean, one of the most basic examples is [[Apple Mail]], right?                                          |
| 09:48      | Apple Mail's keyboard shortcut to send an email is command shift D. It's like, what were              |
...
| 10:27      | So I'm going to go back to these groups and keyboard my show, but if you just give it a               |
...
| 13:22      | Um, and what I'll do when I do that is I will also use the great comment feature in Keyboard          |
| 13:27      | Maestro to add a comment, uh, into that macro and just say, Hey, this is what it's for and            |
...
| 14:34      | the OCR engine in keyboard, my show was one called Tesseract.                                         |
...
| 14:51      | Like I, I noticed like on a dark screen, it barely worked and there's some form threads               |
...
| 23:41      | And I'm, I'm just loving the fact that this is something that happens every time keyboard             |
| 23:44      | maestro comes out with a bunch of new features.                                                       |
...
| 26:37      | forget about all of those now and just use Keeper Maestro to set my screen resolution.                |
...
| 28:58      | If you've got a pushover account, you can now send notifications directly from Keyboard               |
| 29:03      | Maestro to pushover.                                                                                  |
...
| 33:07      | I mean, that's what the Stream Decks for.                                                             |
...
| 36:27      | In other news, I've started an automation podcast with Steven Hackett, uh, who is also                |
| 36:31      | an orange fan.                                                                                        |
| 36:32      | Um, no, I'm kidding.                                                                                  |
| 36:33      | I'm kidding folks.                                                                                    |
| 36:34      | Uh, the fact that both of you are such big fans of orange and yet the MPU artwork is                  |
...
| 43:00      | If they've got any snippets in KeeboMeister referencing their personal information, use               |
...
| 43:34      | directly in KeeboMeister, so I was using shortcuts to do it.                                          |
...
| 45:06      | Maestro, you can select the whole block of actions and duplicate them or copy them.                   |
...
| 45:30      | And it's like it goes slow and then it goes really fast and then suddenly you're a complicated        |
| 45:35      | shortcut is out of order and you're not sure where and that's never fun.                              |
| 45:40      | Yeah.                                                                                                 |
| 45:41      | Yeah.                                                                                                 |
| 45:42      | So I saw you surprised to you, David.                                                                 |
...
| 48:47      | Yeah, I use this in so many contexts because, like, for the MaxWorkingLab stuff that I sent           |
| 48:52      | to JF, he helps me edit them.                                                                         |
...
| 49:31      | And I'm doing this all with Keybow Maestro.                                                             |
| 49:33      | So Keybow Maestro, when I start doing the recording, will create a new file in the correct folder,      |
...
| 49:45      | I'm using my stream diapetal, and it's writing Keybow Maestro macros.                                   |
...
| 55:40      | Maestro, you can do them in shortcuts, you can do them in bunch, and I am confused because            |
...
| 58:26      | You can find the forums for the automators over at talk.automators.fm and you can go                  |
| 58:30      | check it out.                                                                                         |
