...
> [!QUESTION]- Episode Trivia: Did you know?
...
| 05:13      | moment to automate the thing that I was going to do than to do the thing.                              |
...
| 20:37      | that's something that they could solve.                                                                |
...
| 24:32      | For automated listeners, electric are offering a free pair of beat solo three headphones               |
...
| 46:16      | And then it turned out that the hardest thing to do was to actually get a correctly formatted          |
...
| 49:18      | shortcuts. And like, but unless I have a thing I actually want to do or a thing that I think about,    |
...
| 55:54      | And right now, for a limited time, you can take advantage of the generous rebate savings opportunities |
...
| 01:05:34   | I was like, well, I want to track my weight. My doctor is always recommended that I weigh              |
...
| 01:11:56   | health devices. And so I just went a bit nuts with NFC stickers. So my dad's blood glucose             |
...
| 01:12:47   | I will, I'll throw out there this other one that I made, which is it's, it's a little complex,         |
| 01:12:53   | but has a very basic premise, which is every day I read a set of comics via a browser.                 |
| 01:13:01   | And I wanted to create a shortcut to open all of these at the same time, because I have a bookmark     |
| 01:13:07   | group, which is fine. But the trick was some of them only update on certain days. And so I             |
| 01:13:14   | didn't want it to open the ones that were not new on those days. So I have some that update on         |
| 01:13:18   | Monday, Wednesday, Friday. I have some that only show up on Sunday. And I wanted to be able to make    |
| 01:13:22   | this like, oh, can I make a customised shortcut for doing this? And I did write this up also at        |
| 01:13:27   | six dollars at one point. But essentially what it takes is it starts out with a dictionary that's      |
| 01:13:32   | basically a multi, a multi dimensional dictionary that includes both a schedule within it and a        |
| 01:13:39   | URL. Okay. And then it runs a big loop basically over that take, you know, gets the current date       |
| 01:13:45   | figures out like what date it is, what day of the week. Yeah. And then it creates a list of all        |
| 01:13:54   | these, the, you know, applicable one, like a basic creates a list and then repeats over that list,     |
| 01:14:00   | checks the date sees if that date is within the schedule in order to do this, I basically created      |
| 01:14:05   | like a ad hoc scheduling format, where it is basically I just use a two letter abbreviation            |
| 01:14:13   | and string them all together as a string. So like the schedule might say like, you know,               |
| 01:14:18   | m o a capital M lowercase o capital W lowercase e capital F lowercase r for Monday, Wednesday,         |
| 01:14:24   | Friday, etc. It checks for that. And then the trick for this was one of the sites where I read a       |
| 01:14:30   | bunch of comics has, it's kind of annoying the URL for the actual strip is basically, you know,        |
| 01:14:40   | the name of the site slash the name of the street, the strip slash year slash month slash day, right,  |
| 01:14:48   | like your standard sort of thing, but like all there's like different, it's a rewrite, etc,            |
| 01:14:52   | blah, blah, blah. And so you can't bookmark it right because the date hasn't happened yet.             |
| 01:14:57   | And so I could make bookmark folders that just open the generic tape, but it means every time I        |
| 01:15:01   | have to click through like, okay, because it only shows you like a like part of the strip and you      |
| 01:15:04   | have to like click through because it gets me really annoyed. So I was like, well, I just wanted       |
| 01:15:07   | to build the URLs for me. So that's essentially what I have it do is I have it go like, Hey,           |
...
| 01:16:12   | everything works great. So that's a little handy tool I built for myself just because I was like,      |
| 01:16:18   | there must be an easier way to do this, the, I think, which is the credo of all automators everywhere. |
| 01:16:25   | Absolutely. And I love that. I found the post on Six Colors, by the way, and put a link to             |
| 01:16:29   | that in the show notes for anybody who's looking. It's there with automate this reading comics.        |
| 01:16:34   | And I love that idea. And I have different links to open on different days. So I'm going to be         |
